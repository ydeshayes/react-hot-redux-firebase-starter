...
import ChatPage from './components/chats/ChatPage'; //eslint-disable-line import/no-named-as-default
import Discussion from './components/chats/DiscussionPage'; //eslint-disable-line import/no-named-as-default
  ...
  return (
    <Route path="/" component={Layout}>
      ...
      <Route path="chats" component={ChatPage}>
        <Route path=":chatUid" component={Discussion}/>
      </Route>
    </Route>
  );
}
